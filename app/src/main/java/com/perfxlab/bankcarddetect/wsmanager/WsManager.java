...
public class WsManager implements IWsManager {
    private final static int RECONNECT_INTERVAL = 1000;//10 * 1000;    //重连自增步长
    private final static long RECONNECT_MAX_TIME = 10 * 1000;//120 * 1000;   //最大重连间隔
    ...
    private boolean send(Object msg) {
        ...
        }else if(mCurrentStatus == WsStatus.DISCONNECTED){
            tryReconnect();
        }
        return isSend;
    }
